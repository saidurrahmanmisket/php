...
?>
    ...
    <body class=" w-100 vh-100 bg-dark text-light">
        <div class="header mt-5 mb-5">
            <a class="btn btn-danger text-center" href="/"> Back </a>
            <h1 class="text-center">All Member</h1>
            
            <h2 class=""><?php session_start(); print_r($_SESSION['username']) ?></h2>
        </div>
        <main>
            <?php
            ...
            ?>
                <div class="myCard">
                    <div class="cardLeft">
                        <img class="img-fluid " style="min-height:250px; max-height:250px; min-width: 200px;" src="./uploads/<?php echo $originalFileName ?>" alt="">
                    </div>
                    <div class="cardRight">
                        <h1 class="text-danger"><?php echo $username ?></h1>
